...
public class TaskTitleStepDefinition {
	...
	public void I_enter_in_the_title_textbox_and_I_push_the_add_button(
		...
		WebElement searchButton = driver.findElement(By.id("add-task-button"));
		searchButton.click();
	}
	...
	public void I_should_get_result_in_stories_list(String expectedResult)
			throws Throwable {
		WebElement calculatorTextBox = driver.findElement(By.id("task-title"));
